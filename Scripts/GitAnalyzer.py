...
def get_author(name, email, author_info):
    ...
    for author in author_info:
        if author['email'].lower() == email:
            return author['name'], author['email'], author['country'], author['city']
        
        for alias in author['aliases']:
            if alias.lower() == email:
                return author['name'], author['email'], author['country'], author['city']
        
    return name, email, 'Unknown', 'Unknown'
...
def build_commits(repo, author_info):
    ...
    for commit in repo.traverse_commits():
        ...
        try:
            ...
            name, email, country, city = get_author(author.name, author.email, author_info)
